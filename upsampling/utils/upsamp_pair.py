...
class Upsampler:
    def __init__(self, image_dim, is_train, device: str, num_interp_frames:int=10):
        self.crop = CropParameters(image_dim[1], image_dim[0], 6)
    ...
    def upsample_pair(self, img_pair, time_pair):
        ...
        for i, frame in enumerate(total_frames):
            ...
            final_frames.append(cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY))
